...
class JointLimit(URDFType):
    ...
    def __init__(self, effort=None, velocity=None, lower=None, upper=None):
        ...
        # NOTE: The genesis team seems to have added these conditions, but it does not quite make sense
        # if effort is None:
        #     effort = 0.0
...
class URDF(URDFType):
    ...
    # NOTE: The below code seems to be something that the Genesis team added but is unused
    ...
    #     link_canonical: List[float] = [
    #         0.0,
    #         0.0,
    #         1.0,
    #     ],  # growing upward --> by setting rotmat, we can grow
    ...
    #             link_rotmat = rotation_matrix_from_vectors(
    #                 link_canonical, link_edge_vec
    #             )
    ...
    #                 joint_edge_vec2 = norm_vec(
    #                     G_pos[grandchild_node] - G_pos[child_node]
    #                 )
    ...
    #                 joint_axis = (
    #                     joint_rotvec / joint_init_ang
    #                 )  # the same as np.cross(joint_edge_vec2, joint_edge_vec1)
